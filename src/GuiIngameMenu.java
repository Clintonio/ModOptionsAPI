...
import net.minecraft.src.modoptionsapi.GuiModScrollOptions;
//====================
// END MODOPTIONSAPI
//====================
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(5, width / 2 - 100, height / 4 + 48 + byte0, 98, 20, StatCollector.func_25200_a("gui.achievements")));
        controlList.add(new GuiButton(6, width / 2 + 2, height / 4 + 48 + byte0, 98, 20, StatCollector.func_25200_a("gui.stats")));
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
		...
		if(guibutton.id == 30) {
			...
			if(mc.isMultiplayerWorld()) {	
				...
				// Get the world name
				String name = mc.theWorld.func_22144_v().getWorldName();
